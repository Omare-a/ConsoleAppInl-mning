        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleEntityRoleId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleEntities", x => x.RoleId);
                    table.ForeignKey(
                        name: "FK_RoleEntities_RoleEntities_RoleEntityRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_RoleEntities_RoleId",
                        column: x => x.RoleId,
                        principalTable: "RoleEntities",
                        principalColumn: "RoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProductRow", x => new { x.OrderId, x.RowId });
                    table.ForeignKey(
                        name: "FK_OrderProductRow_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderProductRow_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProductRow_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleEntities_RoleEntityRoleId",
                table: "RoleEntities",
